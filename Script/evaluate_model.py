...
def save_evaluation_results(results_dir, accuracy, precision, recall, f1, report):
    os.makedirs(results_dir, exist_ok=True)
    results_path = os.path.join(results_dir, 'evaluation_report.txt')
...
def main(model_path, data_dir, results_dir):
    ...
    save_evaluation_results(results_dir, accuracy, precision, recall, f1, report)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', '--data_dir', type=str, required=True, help="Directory where the test data is stored.",default='Data/')
    parser.add_argument('-r', '--results_dir', type=str, required=True, help="Directory to save evaluation results.",default='Result/scores')
