...
def train_model(X_train, y_train, model_name='xgboost', params=None):
    ...
    #     model = CatBoostClassifier(verbose=0, **(params or {}))
        ...
        raise ValueError(f"Model {model_name} is not supported. Choose from 'xgboost', 'catboost', 'lgbm', 'gbdt', 'random_forest', 'svm', or 'logistic_regression'.")
...
def main(data_dir, model_dir, model_name='xgboost', params=None):
    # Load training data
...
if __name__ == "__main__":
    ...
    main(args.data_dir, args.model_dir, args.model_name, params)
