...
predict: deploy
	...
	python Script/predict_data.py --model $(DEPLOYED_MODEL) --preprocessor $(PREPROCESSOR_DIR) --data_dir $(NEW_DATA_DIR) --output "$(TEST_RESULT_DIR)/predictions_$(TIMESTAMP).csv"
